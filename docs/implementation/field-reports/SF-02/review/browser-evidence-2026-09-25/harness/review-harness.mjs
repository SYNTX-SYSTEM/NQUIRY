/**
 * SF-02 visible-website review harness (evidence tool; not a product test).
 *
 * Real Chromium against the isolated inspection runtime (compose project
 * `nquiry-sf02-inspect`, http://127.0.0.1:13200). For every reviewed state it
...
const BASE = process.env.INSPECT_BASE ?? "http://127.0.0.1:13200";
const API = `${BASE}/api`;
...
const VIEWPORTS = { desktop: { viewport: { width: 1280, height: 860 } }, "pixel-7": { ...devices["Pixel 7"] } };
const results = [];
let seq = 0;
