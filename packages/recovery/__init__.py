"""recovery: 10 recovery orchestration.

Architectural ownership (14_IMPLEMENTATION_SEQUENCE.md §3.1):
    Responsibility     : 10 recovery orchestration.
    May depend on      : command, boundaries, commit, recovery ports.
    Must not depend on : unrestricted DB writer.
    Canonical write    : only governed Recovery Command.
