"""Shared fixtures for T7 command/commit/event tests that need a real
PostgreSQL instance.

Identical `SKIPPED_NO_DATABASE` convention as `tests/boundaries/conftest.py`,
`tests/domain/conftest.py`, `tests/authority/conftest.py`, etc.
"""
